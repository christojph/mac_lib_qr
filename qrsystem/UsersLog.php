...
<body>
  ...
  <section class="container py-lg-5">
    <!--User table-->
    <h1 class="slideInDown animated m2">Here are the Users daily logs</h1>
                ...
                <div class="row">
                  <div class="col-lg-4 col-sm-12">
                    ...
                    <select class="card_sel" name="card_sel" id="card_sel">
                      ...
                      $sql = "UPDATE users_logs SET department=(SELECT email FROM users WHERE users_logs.card_uid=users.card_uid);";
                      /*$sql = "INSERT INTO users_logs(department) SELECT email FROM users";*/
