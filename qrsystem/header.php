...
<header>
	<div class="header">
		<div class="logo">
			<a href="http://novianhub.s3-website.us-east-2.amazonaws.com/" target="_blank"><img src="logo.png" height="100px" style="float: left;" alt="Novian Hub"></a><a href="index.php">Automatic Time Keeper</a>
		</div>
	</div>
	<div class="m1"><marquee>A Product Of Novian Hub. Developed By Christo Joseph And Toney Abraham.[Msc Electronics 2020-22]</marquee></div>
	<?php  
	if (isset($_GET['error'])) {
					...
					if (isset($_GET['login'])) {
						if ($_GET['login'] == "success") {
							...
							<div class="topnav" id="myTopnav">
								...
								<!-- <a onclick="window.location.href = 'time.php ?>';">Reset Time</a> -->
								</div>
									...
									<div class="modal-content">
										...
										<form action="ac_update.php" method="POST" enctype="multipart/form-data">
											...
											<div class="modal-footer">
												...
												">
											Delete</a>
											<button class="bttn" onclick="window.location.href = 'sqldwnd.php ?>';">Download Database</button>
