...
<main>
	<h1 class="slideInDown animated m2">Add a new User or update his information <br> or remove him</h1>
	<div class="form-style-5 slideInDown animated">
		<form enctype="multipart/form-data">
			...
			<fieldset>
				...
				<input type="text" name="number" id="number" placeholder="Class Number">
				<input type="email" name="email" id="email" placeholder="PG/UG year Department">
			</fieldset>
			<fieldset>
